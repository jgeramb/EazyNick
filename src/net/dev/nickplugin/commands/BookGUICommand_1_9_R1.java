...
import net.dev.nickplugin.utils.bookutils.BookBuilder_1_9_R1;
import net.dev.nickplugin.utils.bookutils.BookUtils_1_9_R1;
import net.md_5.bungee.api.chat.ClickEvent;
import net.md_5.bungee.api.chat.HoverEvent;
import net.md_5.bungee.api.chat.TextComponent;

public class BookGUICommand_1_9_R1 implements CommandExecutor {
		...
		if(sender instanceof Player) {
			...
			if(p.hasPermission("nick.gui") || Utils.hasLuckPermsPermission(p.getUniqueId(), "nick.gui")) {
				...
				if(args.length == 0) {
					...
					BookUtils_1_9_R1.open(p, BookBuilder_1_9_R1.create("Ranks", 
					...
					BookUtils_1_9_R1.open(p, BookBuilder_1_9_R1.create("Skin", 
					...
					BookUtils_1_9_R1.open(p, BookBuilder_1_9_R1.create("Name", 
					...
					if(args[2].equalsIgnoreCase("RANDOM")) {
						...
						BookUtils_1_9_R1.open(p, BookBuilder_1_9_R1.create("RandomNick",
