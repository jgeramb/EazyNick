...
import net.dev.nickplugin.utils.bookutils.BookUtils_1_8_R1;
import net.dev.nickplugin.utils.bookutils.BookUtils_1_8_R1.ClickAction;
import net.dev.nickplugin.utils.bookutils.BookUtils_1_8_R1.HoverAction;
import net.dev.nickplugin.utils.bookutils.BookUtils_1_8_R1.PageBuilder;

public class BookGUICommand_1_8_R1 implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		if(sender instanceof Player) {
			...
			if(p.hasPermission("nick.gui") || Utils.hasLuckPermsPermission(p.getUniqueId(), "nick.gui")) {
				...
				if(args.length == 0) {
					BookUtils_1_8_R1 bu = new BookUtils_1_8_R1("Nick", "Ranks");
					...
					BookUtils_1_8_R1.open(p, bu.build(), false);
				} else if(args.length == 1) {
					BookUtils_1_8_R1 bu = new BookUtils_1_8_R1("Nick", "Skin");
					...
					BookUtils_1_8_R1 bu = new BookUtils_1_8_R1("Nick", "Name");
					...
					if(args[2].equalsIgnoreCase("RANDOM")) {
						BookUtils_1_8_R1 bu = new BookUtils_1_8_R1("Nick", "RandomName");
