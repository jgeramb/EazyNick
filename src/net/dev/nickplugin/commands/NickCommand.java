										...
										if(!(nickNameIsInUse)) {
											...
											if(!(isCancelled)) {
												if(!(name.equalsIgnoreCase(p.getName()))) {
													...
													Bukkit.getPluginManager().callEvent(new PlayerNickEvent(p, nameWhithoutColors, nameWhithoutColors, chatPrefix, chatSuffix, tabPrefix, tabSuffix, tagPrefix, tagSuffix, false));
												} else {
