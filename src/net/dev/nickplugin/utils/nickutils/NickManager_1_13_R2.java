...
public class NickManager_1_13_R2 {
	...
	public static void changeSkin(CraftPlayer cp, String skinName) {
		...
		if(FileUtils.cfg.getBoolean("SeeNickSelf") == true) {
			...
			PacketPlayOutRespawn packet = new PacketPlayOutRespawn(((CraftWorld)cp.getPlayer().getWorld()).getHandle().dimension, ep.getWorld().getDifficulty(), ep.getWorld().getWorldData().getType(), ep.playerInteractManager.getGameMode());
