...
public class BookUtils_1_8_R2 {

	private String title;
	private String author;
	private List<String> pages = new ArrayList<String>();

	public BookUtils_1_8_R2(String title, String author) {
        this.title = title;
        this.author = author;
    }
	...
	public static final class PageBuilder {
		...
		private BookUtils_1_8_R2 book;

		public PageBuilder(BookUtils_1_8_R2 bookUtils) {
			this.book = bookUtils;
		}
