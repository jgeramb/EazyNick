...
public class LanguageFileUtils {
	...
	public static File folder = new File("plugins/" + EazyNick.getInstance().getDescription().getName() + "/lang/");
	public static File file = new File("plugins/" + EazyNick.getInstance().getDescription().getName() + "/lang/de_DE.yml");
