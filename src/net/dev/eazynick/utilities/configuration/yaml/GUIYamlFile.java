...
public class GUIYamlFile extends YamlFile {
	...
	public void setDefaults() {
		...
		configuration.addDefault("BookGUI.Page1.Text", "&0Nicknames allow you to play with a different\nusername to not get recognized.\n\nAll rules still apply. You can still be reported and all name history is stored.\n\n");
		configuration.addDefault("BookGUI.Page1.Enabled", true);
		configuration.addDefault("BookGUI.Page2.Title", "Ranks");
		configuration.addDefault("BookGUI.Page2.Text", "&0Let's get you set up with your nickname! First, you'll need to choose which &lRANK &0you would like to be shown as when nicked.\n\n");
		configuration.addDefault("BookGUI.Page3.Title", "Skin");
		configuration.addDefault("BookGUI.Page3.Text","&0Awesome! Now, which &lSKIN &0would you like to have while nicked?\n\n");
		configuration.addDefault("BookGUI.Page4.Title", "Name");
		configuration.addDefault("BookGUI.Page4.Text", "&0Alright, now you'll need to choose the &0&lNAME &0to use!\n\n");
		configuration.addDefault("BookGUI.Page5.Title", "RandomNick");
		configuration.addDefault("BookGUI.Page5.Text", "&0We've generated a random username for you:\n&l%name%\n\n");
		configuration.addDefault("BookGUI.Page5.Text2", "&0To go back to being your usual self, type:\n&l/nick reset");
		configuration.addDefault("BookGUI.Page6.Title", "Done");
		configuration.addDefault("BookGUI.Page6.Text.SingleServer", "&0You have finished setting up your nickname!\n\nYou are now nicked as\n%name%&0.\n\nTo go back to being your usual self, type:\n&l/nick reset");
		configuration.addDefault("BookGUI.Page6.Text.BungeeCord", "&0You have finished setting up your nickname!\n\nWhen you go into a game, you will be nicked as\n%name%&0.\n\nTo go back to being your usual self, type:\n&l/nick reset");
		configuration.addDefault("BookGUI.Page6.Enabled", true);
		
		configuration.addDefault("BookGUI.Accept.Text", arrow + " &nI understand, set&r\n&0&nup my nickname&r");
		configuration.addDefault("BookGUI.Accept.Hover", "&fClick here to proceed");
		configuration.addDefault("BookGUI.Rank.Text", arrow + " %rank%\n");
		configuration.addDefault("BookGUI.Rank.Hover", "&fClick here to be shown as %rank%");
		configuration.addDefault("BookGUI.NormalSkin.Text", arrow + " &0My normal skin\n");
		configuration.addDefault("BookGUI.NormalSkin.Hover", "&fClick here to use your normal skin");
		configuration.addDefault("BookGUI.SteveAlexSkin.Text", arrow + " &0Steve/Alex skin\n");
		configuration.addDefault("BookGUI.SteveAlexSkin.Hover", "&fClick here to use a Steve/Alex skin");
		configuration.addDefault("BookGUI.RandomSkin.Text", arrow + " &0Random skin\n");
		configuration.addDefault("BookGUI.RandomSkin.Hover", "&fClick here to use a random skin");
		configuration.addDefault("BookGUI.SkinFromName.Text", arrow + " &0Use skin of nickname\n");
		configuration.addDefault("BookGUI.SkinFromName.Hover", "&fClick here to use the skin of your nickname");
		configuration.addDefault("BookGUI.ReuseSkin.Text", arrow + " &0Reuse %skin%\n");
		configuration.addDefault("BookGUI.ReuseSkin.Hover", "&fClick here to reuse your previous skin");
		configuration.addDefault("BookGUI.EnterName.Text", arrow + " &0Enter a name\n");
		configuration.addDefault("BookGUI.EnterName.Hover", "&fClick here to enter a name");
		configuration.addDefault("BookGUI.RandomName.Text", arrow + " &0Use random name\n");
		configuration.addDefault("BookGUI.RandomName.Hover", "&fClick here to use a random name");
		configuration.addDefault("BookGUI.ReuseName.Text", arrow + " &0Reuse '%name%'\n");
		configuration.addDefault("BookGUI.ReuseName.Hover", "&fClick here to reuse '%name%'");
		configuration.addDefault("BookGUI.OptionUseName.Text", "     &a&nUSE NAME&r\n");
		...
		configuration.addDefault("BookGUI.OptionEnterName.Text", "&0&nOr enter a name to&r\n&0&nuse.&r\n\n");
