    ...
    public void sendActionBar(Player player, String text) {
        try {
            ...
            if (eazyNick.getVersion().startsWith("1_7_") || eazyNick.getVersion().startsWith("1_8_")) {
                ...
                sendPacket(
                        player,
                        reflectionHelper.getNMSClass("PacketPlayOutChat")
                                .getConstructor(reflectionHelper.getNMSClass("IChatBaseComponent"), byte.class)
                                .newInstance(
                                        chatSerializer
    ...
    private void sendPacket(Player player, Object packet) {
        ...
        try {
            ...
            playerConnection.getClass()
                    .getMethod("sendPacket", reflectionHelper.getNMSClass("Packet"))
