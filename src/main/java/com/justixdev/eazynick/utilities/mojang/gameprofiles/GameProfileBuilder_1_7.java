...
public class GameProfileBuilder_1_7 {
    ...
    private static final Gson GSON = new GsonBuilder()
            ...
            .registerTypeAdapter(GameProfile.class, new GameProfileBuilder_1_7.GameProfileSerializer())
            .registerTypeAdapter(PropertyMap.class, new PropertyMap.Serializer())
            .create();
    private static final HashMap<UUID, GameProfileBuilder_1_7.CachedProfile> CACHE = new HashMap<>();
